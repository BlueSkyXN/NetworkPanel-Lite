<template>
  ...
  <el-dialog style="width: 90%;max-width: 400px;" v-model="aboutVisible" title="关于">
    <div>
      ...
      <h2>网络面板</h2>
      -->
      <span>原始作者：<el-link @click='open("https://netart.cn/")' type="primary">Whoami</el-link></span><br>
      <span>源代码：<el-link @click='open("https://github.com/ljxi/NetworkPanel")' type="primary">Github</el-link></span><br>
      <hr>
      本站基于<a href="https://net.ljxnet.cn/" target="_blank" rel="noopener external nofollow noreferrer">原始作者的版本</a>做了一些调整, 仅保留前端网络测试功能.<br><br>
        <strong>移除了依赖于第三方的:</strong>
        <li>QQ 登录与排行榜</li>
        <li>百度统计</li>
        <li>51la 统计</li>
        <li>IP 地址查询功能</li>
        <br>
        <strong>移除了依赖于后端的:</strong>
        <li>用户管理</li>
        <li>测速日志上传</li>
        <li>测速入口</li><br>
        <strong>其他方面:</strong>
        <li>调整页面元素</li>
        <li>将前端静态资源端点从 <a href="https://cdn.iocdn.cc/" target="_blank" rel="noopener external nofollow noreferrer">cdn.iocdn.cc</a> (一为云, 括彩云提供) 替换为 <a href="https://cdnjs.cloudflare.com/" target="_blank" rel="noopener external nofollow noreferrer">cdnjs.cloudflare.com</a> (Cloudflare 提供).</li>
      <!--
